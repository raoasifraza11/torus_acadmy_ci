...
<div id="main_content">
    ...
    <div id="left-sidebar" class="sidebar">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#menu-uni">User</a></li>
...
<script src="<?php echo asset_url('bundles/lib.vendor.bundle.js') ?>"></script>

<!-- Start all plugin js -->
<script src="<?php echo asset_url('bundles/counterup.bundle.js'); ?>"></script>
<script src="<?php echo asset_url('bundles/apexcharts.bundle.js'); ?>"></script>
<script src="<?php echo asset_url('bundles/summernote.bundle.js'); ?>"></script>

<!-- Start project main js  and page js -->
<script src="<?php echo asset_url('js/core.js'); ?>"></script>
<script src="<?php echo asset_url('js/page/index.js'); ?>"></script>
<script src="<?php echo asset_url('js/page/summernote.js'); ?>"></script>
</body>
