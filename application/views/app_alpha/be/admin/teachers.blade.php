                                    ...
                                    <tr>
                                        <td class="w60">
                                            <div class="avatar avatar-pink" data-toggle="tooltip" data-placement="top" title="" data-original-title="Avatar Name">
                                                <span>{{ucfirst($teacher->first_name[0]).ucfirst($teacher->last_name[0])}}</span>
                                            </div>
                                        </td>
                                        <td><div class="font-15">{{ucfirst($teacher->first_name)." ".ucfirst($teacher->last_name)}}</div></td>
                                        <td><span>{{$teacher->email}}</span></td>
                                        <td><strong>{{date("Y-m-d",strtotime($teacher->created_at))}}</strong></td>
                                        <td>
