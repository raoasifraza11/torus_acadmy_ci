        ...
        <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li><a href="#"><i class="fa fa-black-tie"></i><span>Students</span></a></li>
                    <li><a href="#"><i class="fa fa-users"></i><span>Teachers</span></a></li>
                    <li><a href="#"><i class="fa fa-users"></i><span>Invoices</span></a></li>
                    <li><a href="#"><i class="fa fa-users"></i><span>Revenue</span></a></li>
                    <li><a href="#"><i class="fa fa-users"></i><span>Chat</span></a></li>
                </ul>
            </nav>
        </div>
        <div class="tab-pane fade" id="menu-admin" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li><a href="#"><i class="fa fa-graduation-cap"></i><span>Site Configuration</span></a></li>
                    <li><a href="#"><i class="fa fa-gear"></i><span>Copyrights</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
