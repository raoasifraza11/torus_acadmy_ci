    ...
    <div class="tab-content mt-3">
        <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    <li class="active"><a href="<?php echo base_url('teacher/dashboard'); ?>"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
                    <li><a href="<?php echo base_url('teacher/enrolled/students'); ?>"><i class="fa fa-clock-o"></i><span>Enrolled Students</span></a></li>
                    <li><a href="<?php echo base_url('teacher/revenue'); ?>"><i class="fa fa-money"></i><span>Revenue</span></a></li>
                    <li><a href="<?php echo base_url('teacher/profile'); ?>"><i class="fa fa-users"></i><span>Profile Setting</span></a></li>
                </ul>
            </nav>
        </div>
