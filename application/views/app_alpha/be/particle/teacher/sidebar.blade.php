<div id="left-sidebar" class="sidebar">
    ...
    <div class="tab-content mt-3">
        <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li><a href="#"><i class="fa fa-clock-o"></i><span>Enrolled Students</span></a></li>
                    <li><a href="#"><i class="fa fa-money"></i><span>Revenue</span></a></li>
                    <li><a href="#"><i class="fa fa-users"></i><span>Profile Setting</span></a></li>
                </ul>
            </nav>
        </div>
        <div class="tab-pane fade" id="menu-admin" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    <li><a href="#"><i class="fa fa-credit-card"></i><span>Account Details</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
