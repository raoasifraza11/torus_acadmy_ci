				...
				<div class="col-sm-4">
					<div class="course__item">
						...
						<div class="course-item__content">
							...
							<h3>
								<a href="<?php echo base_url('course/single');  ?>">Flat design in web</a>
							</h3>
							<p class="course-item__desc">Lorem ipsum dolor sit amet, consetetur adipiscing elitsed do eius.</p>
							<a class="btn btn-primary" href="<?php echo base_url('course/single');  ?>">Choose course</a>
				...
				<div class="col-sm-4">
					<div class="course__item">
						...
						<div class="course-item__content">
							...
							<h3>
								<a href="<?php echo base_url('course/single');  ?>">Java: introduction</a>
							</h3>
							<p class="course-item__desc">Lorem ipsum dolor sit amet, consetetur adipiscing elitsed do eius.</p>
							<a class="btn btn-primary" href="<?php echo base_url('course/single');  ?>">Choose course</a>
						</div> <!-- .teacher-course__content -->
				...
				<div class="col-sm-4">
					<div class="course__item">
						...
						<div class="course-item__content">
							...
							<h3>
								<a href="<?php echo base_url('course/single');  ?>">Ui / Ux training</a>
							</h3>
							<p class="course-item__desc">Lorem ipsum dolor sit amet, consetetur adipiscing elitsed do eius.</p>
							<a class="btn btn-primary" href="<?php echo base_url('course/single');  ?>">Choose course</a>
						</div> <!-- .teacher-course__content -->
				...
				<div class="col-sm-4">
					<div class="course__item">
						...
						<div class="course-item__content">
							...
							<h3>
								<a href="<?php echo base_url('course/single');  ?>">History of information</a>
							</h3>
							<p class="course-item__desc">Lorem ipsum dolor sit amet, consetetur adipiscing elitsed do eius.</p>
							<a class="btn btn-primary" href="<?php echo base_url('course/single');  ?>">Choose course</a>
						</div> <!-- .teacher-course__content -->
				...
				<div class="col-sm-4">
					<div class="course__item">
						...
						<div class="course-item__content">
							...
							<h3>
								<a href="<?php echo base_url('course/single');  ?>">Internet for people</a>
							</h3>
							<p class="course-item__desc">Lorem ipsum dolor sit amet, consetetur adipiscing elitsed do eius.</p>
							<a class="btn btn-primary" href="<?php echo base_url('course/single');  ?>">Choose course</a>
						</div> <!-- .teacher-course__content -->
				...
				<div class="col-sm-4">
					<div class="course__item">
						...
						<div class="course-item__content">
							...
							<h3>
								<a href="<?php echo base_url('course/single');  ?>">Programming languages</a>
							</h3>
							<p class="course-item__desc">Lorem ipsum dolor sit amet, consetetur adipiscing elitsed do eius.</p>
							<a class="btn btn-primary" href="<?php echo base_url('course/single');  ?>">Choose course</a>
						</div> <!-- .teacher-course__content -->
