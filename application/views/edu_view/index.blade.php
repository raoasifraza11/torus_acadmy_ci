...
<div class="main-content">
				...
				<div class="col-lg-8 pr-50 md-pr-15">
					<div class="about-part">
						...
						<div class="sign-part wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2000ms">
							<div class="img-part">
								<img src="assets/images/banner/raja-nadeem.png" alt="CEO Image">
							</div>
							<div class="author-part">
								<span class="sign mb-10"><img src="assets/images/about/sign.png" alt="Sign"></span>
								<span class="post">CEO & Founder of Torus Academy</span>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row y-middle mb-50 md-mb-30">
				<div class="col-md-6 sm-mb-30">
					<div class="sec-title">
						...
						<h2 class="title mb-0 font-color">Popular Courses</h2>
					</div>
				</div>
				<div class="col-md-6">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
					<div class="courses-item">
						<div class="img-part">
							<img src="assets/images/courses/accounts.png" alt="">
						</div>
						<div class="content-part">
							<ul class="meta-part">
								<li><span class="price">$55.00</span></li>
								<li><a class="categorie font-color" href="#">Web Development</a></li>
							</ul>
							<h3 class="title "><a class="font-color" href="course-single.html">Accounts</a></h3>
							<div class="bottom-part">
								<div class="info-meta">
									<ul>
										<li class="user font-color"><i class="fa fa-user"></i> 245</li>
										<li class="ratings">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<span class="font-color">(05)</span>
										</li>
									</ul>
								</div>
								<div class="btn-part">
				...
				<div class="col-lg-4 col-md-6  mb-30 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2000ms">
					<div class="courses-item">
						<div class="img-part">
							<img src="assets/images/courses/biology.png" alt="">
						</div>
						<div class="content-part">
							<ul class="meta-part">
								<li><span class="price">$55.00</span></li>
							...
							<h3 class="title"><a class="font-color" href="course-single.html">Learning jQuery Mobile for Beginners</a></h3>
							<div class="bottom-part">
								<div class="info-meta">
									<ul>
										<li class="user font-color"><i class="fa fa-user"></i> 245</li>
				...
				<div class="col-lg-4 col-md-6  mb-30 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2000ms">
					<div class="courses-item">
						<div class="img-part">
							<img src="assets/images/courses/computer.png" alt="">
						</div>
						<div class="content-part">
							<ul class="meta-part">
								<li><span class="price">$55.00</span></li>
								<li><a class="categorie font-color" href="#">Photography</a></li>
							</ul>
							<h3 class="title"><a class="font-color" href="course-single.html">The Art of Black and White Photography</a></h3>
							<div class="bottom-part">
								<div class="info-meta">
									<ul>
										<li class="user font-color"><i class="fa fa-user"></i> 245</li>
				...
				<div class="col-lg-4 col-md-6  mb-30 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
					<div class="courses-item">
						<div class="img-part">
							<img src="assets/images/courses/physics.png" alt="">
						</div>
						<div class="content-part">
							<ul class="meta-part">
								<li><span class="price">$55.00</span></li>
							...
							<h3 class="title"><a class="font-color" href="course-single.html">Learn Python – Interactive Python Tutorial</a></h3>
							<div class="bottom-part">
								<div class="info-meta">
									<ul>
										<li class="user font-color"><i class="fa fa-user"></i> 245</li>
				...
				<div class="col-lg-4 col-md-6  mb-30 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2000ms">
					<div class="courses-item">
						<div class="img-part">
							<img src="assets/images/courses/maths.png" alt="">
						</div>
						<div class="content-part">
							<ul class="meta-part">
								<li><span class="price">$55.00</span></li>
							...
							<h3 class="title"><a class="font-color" href="course-single.html">Your Complete Guide to Dark Photography</a></h3>
							<div class="bottom-part">
								<div class="info-meta">
									<ul>
										<li class="user font-color"><i class="fa fa-user"></i> 245</li>
				...
				<div class="col-lg-4 col-md-6  mb-30 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2000ms">
					<div class="courses-item">
						<div class="img-part">
							<img src="assets/images/courses/english.png" alt="">
						</div>
						<div class="content-part">
							<ul class="meta-part">
								<li><span class="price">$55.00</span></li>
							...
							<h3 class="title"><a class="font-color" href="course-single.html">From Zero to Hero with Advance Nodejs</a></h3>
							<div class="bottom-part">
								<div class="info-meta">
									<ul>
										<li class="user font-color"><i class="fa fa-user"></i> 245</li>
	...
	<div class="rs-cta section-wrap gray-bg">
		<div class="row align-items-center">
			<div class="col-lg-6">
				<div class="img-part">
					<img src="assets/images/banner/admission-open.jpg" alt="Image">
				</div>
			</div>
	...
	<div id="rs-team" class="rs-team style1 gray-bg pt-94 pb-100 md-pt-64 md-pb-70">
		<div class="container">
			...
			<div class="rs-carousel owl-carousel nav-style2" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="true" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="true" data-md-device-dots="false">
				<div class="team-item">
					<img src="assets/images/teachers/nadeem.jpg" alt="">
					<div class="content-part">
						<h4 class="name"><a href="team-single.html">Raja Nadeem Amin</a></h4>
						<span class="designation">Math Professor</span>
				...
				<div class="team-item">
					<img src="assets/images/teachers/sarwar.jpg" alt="">
					<div class="content-part">
						<h4 class="name"><a href="team-single.html">Muhammad Sarwar Ahmed</a></h4>
						<span class="designation">Pakistan Studies Professor</span>
						<ul class="social-links">
							<li><a href="#"><i class="fa fa-facebook"></i></a></li>
							<li><a href="#"><i class="fa fa-twitter"></i></a></li>
							<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
				...
				<div class="team-item">
					<img src="assets/images/teachers/fozia.jpg" alt="">
					<div class="content-part">
						<h4 class="name"><a href="team-single.html">Fozia Qamar</a></h4>
						<span class="designation">Urdu Professor</span>
						<ul class="social-links">
							<li><a href="#"><i class="fa fa-facebook"></i></a></li>
							<li><a href="#"><i class="fa fa-twitter"></i></a></li>
							<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
				...
				<div class="team-item">
					<img src="assets/images/teachers/taha.jpg" alt="">
					<div class="content-part">
						<h4 class="name"><a href="team-single.html">Muhammad Taha Zaidi</a></h4>
						<span class="designation">Business Accounts</span>
						<ul class="social-links">
							<li><a href="#"><i class="fa fa-facebook"></i></a></li>
							<li><a href="#"><i class="fa fa-twitter"></i></a></li>
							<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
				...
				<div class="team-item">
					<img src="assets/images/teachers/naeem.jpg" alt="">
					<div class="content-part">
						<h4 class="name"><a href="team-single.html">Naeem Amin Raja</a></h4>
						<span class="designation">Chemistry Professor</span>
						<ul class="social-links">
							<li><a href="#"><i class="fa fa-facebook"></i></a></li>
							<li><a href="#"><i class="fa fa-twitter"></i></a></li>
							<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
			...
			<div class="rs-carousel owl-carousel"
				...
				<div class="testi-item">
					<div class="author-desc">
						<div class="desc"><img class="quote" src="assets/images/testimonial/style5/quote2.png" alt="">Professional, responsive, and able to keep up with ever-changing demand and tight deadlines: That’s how I would describe Jeramy and his team at The Lorem Ipsum Company. When it comes to content marketing, you’ll definitely get the 5-star treatment from the Lorem Ipsum Company.</div>
				...
				<div class="testi-item">
					<div class="author-desc">
						<div class="desc"><img class="quote" src="assets/images/testimonial/style5/quote2.png" alt="">I was skeptical of SEO and content marketing at first, but the Lorem Ipsum Company not only proved itself financially speaking, but the response I have received from customers is incredible. The work is top-notch and I consistently outrank all my competitors on Google.</div>
						<div class="author-img">
