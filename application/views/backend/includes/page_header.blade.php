                        ...
                        <div class="notification d-flex">
                            ...
                            <div class="dropdown d-flex">
                                <a href="javascript:void(0)" class="chip ml-3" data-toggle="dropdown">
                                    <span class="avatar" style="background-image: url(./assets/images/xs/avatar5.jpg)"></span> <?php echo $this->session->userdata('first_name');?></a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="{{ base_url('teacherDetailInfo') }}"><i class="dropdown-icon fe fe-user"></i> Profile</a>
                                    ...
                                    <a class="dropdown-item" href="{{ base_url('logout') }}"><i class="dropdown-icon fe fe-log-out"></i> Sign out</a>
                                </div>
                            </div>
                        </div>
                    </div>
