...
@section('title', 'Torus Academy - Settings')
@section('_css')
                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="Tritechteal" type="text">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label>Mobile Number <span class="text-danger">*</span></label>
                                    <input class="form-control" value="+92 345 5119056" type="text">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="info@tritechteal.com">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    <label>City</label>
                                    <input class="form-control" value="Islamabad" type="text">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    <label>Postal Code</label>
                                    <input class="form-control" value="46000" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="card-body">
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" value="tritechteal" disabled="" placeholder="Username">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12">
                            <div class="form-group">
                                <input type="email" class="form-control" value="info@tritechteal.com" placeholder="Email">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12">
                            <div class="form-group">
