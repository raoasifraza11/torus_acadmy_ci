...
@section('title', 'Torus Academy - About')
@section('_css')
<style>
...
<div id="about__page">
        ...
        <div class="container">
            ...
            <div class="row row_centered">
                ...
                <div class="col-sm-6 col-sm-pull-6">
                    <div class="about__wrapper">
                        <img src="./assets1/img/about_img-1.jpg" class="img-responsive" alt="...">
                    </div> <!-- / .about__img -->
                </div>
            </div> <!-- / .row -->
        </div> <!-- / .container -->
    ...
    <section class="section__about">
			<div class="container">
			  <div class="row row_centered">
    	    <div class="col-sm-6">
    	  		<img src="./assets1/img/about_img-2.png" class="img-responsive" alt="...">
    	    </div>
    	    <div class="col-sm-6">
    	    	<div class="about__wrapper">
    	    		<div class="about__title">
