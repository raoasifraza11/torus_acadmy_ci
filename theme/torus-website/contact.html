...
<html lang="en">
  <head>
    ...
    <title>Torus Academy | Contacts</title>
			  ...
			  <div class="row">
				...
				<div class="col-md-3 col-sm-4">
			    	<ul class="footer-links__list">
			    		<li><a href="index.html"><i class="ion-ios-arrow-forward"></i> Home </a></li>
						<li><a href="about.html"><i class="ion-ios-arrow-forward"></i> About us</a></li>
						<li><a href="courses.html"><i class="ion-ios-arrow-forward"></i> Courses</a></li>
						<li><a href="blog-grid.html"><i class="ion-ios-arrow-forward"></i> Blog</a></li>
			    	</ul>
			    </div>
			    <div class="col-md-3 col-sm-4">
			    	<ul class="footer-links__list">
						<li><a href="#"><i class="ion-ios-arrow-forward"></i> Terms & Conditions</a></li>
						<li><a href="#"><i class="ion-ios-arrow-forward"></i> Privacy Policy</a></li>
...
<!-- Mirrored from ygamin.bitbucket.io/lctrs/1.0.2/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Jul 2020 05:54:00 GMT -->
</html>